...
const createTransferRequest = async (req, res) => {
  ...
  try {
    ...
    // 2. Kiểm tra user có phải chủ sở hữu vé không
    ...
    // 3. Chỉ cho phép chuyển nhượng vé đang active
    ...
    // 4. Chỉ cho phép chuyển nhượng vé đã mint
    ...
    // 5. Giới hạn chuyển nhượng 1 lần
    ...
    // 6. Không cho chuyển cho chính ví hiện tại
    ...
    // 7. Tìm user nhận qua wallet đã liên kết trong hệ thống
    ...
    // 8. Không cho chuyển cho chính account hiện tại
    ...
    // 9. Mỗi vé chỉ có 1 yêu cầu pending tại một thời điểm
